...
export const getUserById = async (req, res) => {
  try {
    ...
    const user = await User.findById(id).populate("feedbacks").populate("rooms").populate("messages");
...
export const getUsers = async (req, res) => {
  try {
    const users = await User.find().populate("feedbacks").populate("rooms").populate("messages");
